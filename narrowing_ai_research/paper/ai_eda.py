...
def make_category_distr_time(
    ai_indices, arx, cats, cat_sets, get_examples=False, example_n=4
):
...
def main():
    ...
    timecharts, catcharts = make_category_distr_time(ai_indices, arx, cats, False)

    plot_2, trends = make_chart_2(timecharts)
